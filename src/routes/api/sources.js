...
router.post('', function(req, res) {
  res.status(200).json({
    'source': {
      ...
      'dataset_ids': [],
      'data_file': {
        'id': '53c7e7b668796493d3010000',
        'filename': 'hello.csv',
        'type': 'S3',
        'url': STUBBED_S3_URL + '/upload/file/to/s3' + '?AWSAccessKeyId=our_aws_access_key_id&Expires=date&Signature=encoded_signature&x-amz-acl=private'
      }
    }
  });
});
